...
public class UnitTest {
    ...
    public void testInsertionComplex1() {
        ...
        try {
            List<Integer> inp = Arrays.asList(1, 3, 7, 10, 11, 13, 14, 15, 18, 16, 19, 24, 25, 26, 21, 4, 5, 20, 22, 2, 17, 12, 6);
            for (int i : inp)
            ...
            lvl0.add(new ArrayList<>(Arrays.asList(4, 10, 15, 20, 24)));
            List<List<?>> lvl1 = new ArrayList<>();
            lvl1.add(new ArrayList<>(Arrays.asList(1, 2, 3)));
            lvl1.add(new ArrayList<>(Arrays.asList(5, 6, 7)));
            lvl1.add(new ArrayList<>(Arrays.asList(11, 12, 13, 14)));
            lvl1.add(new ArrayList<>(Arrays.asList(16, 17, 18, 19)));
            lvl1.add(new ArrayList<>(Arrays.asList(21, 22)));
            lvl1.add(new ArrayList<>(Arrays.asList(25, 26)));
            ans.add(lvl0);
            ans.add(lvl1);
    ...
    public void testSearchSimple2() {
        ...
        try {
            ...
            for (int i = 0 ; i < inp.size() ; i++)
                btree.insert(inp.get(i), "Soso" + inp.get(i));
